...
SRC_URI="https://github.com/denoland/${PN}/releases/download/v${PV}/deno_src.tar.gz -> ${P}.tar.gz
...
RDEPEND="${DEPEND}"
BDEPEND="
	>=dev-lang/rust-1.43[llvm_targets_WebAssembly(+),wasm(+)]
"
